...
namespace USync.Utility
{
    ...
    class IniFileManager
    {
        ...
        // Const
        //
        private const string IniFilePath = @".\USync.ini";
        ...
        public void SetData(string section, string key, object value)
        {
            ...
            sections[section][key] = value.ToString();
        }
        ...
        public bool ReadFromFile()
        {
            ...
            {
                Console.WriteLine("iniファイルが読み込めませんでした。" + e.Message);
                return false;
            }
            return true;
        }
        ...
        public bool WriteToFile()
        {
            ...
            {
                Console.WriteLine("iniファイルの書き込みに失敗しました。" + e.Message);
                return true;
            }
            return true;
        }
